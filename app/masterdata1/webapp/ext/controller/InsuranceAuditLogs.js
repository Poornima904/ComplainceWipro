sap.ui.define([
    ...
    var oInsuranceAuditDialog
    return {
        insuranceAuditLogsPress: function(oEvent) {
            debugger
            oInsuranceAuditDialog = new Dialog({
...
///////////////////////////////////////////////// m.Table ////////////////////////////
            ...
            var oFilter = new Filter("Entity",FilterOperator.Contains,"insurance")
            ...
            oInsuranceAuditDialog.addContent(oTable);
            this._view.addDependent(oInsuranceAuditDialog);
        // }
        oInsuranceAuditDialog.open();
        }
    };
});
