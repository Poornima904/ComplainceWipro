		...
		override: {
			...
			routing: {
				onBeforeBinding: async function (oEvent) {
					...
					debugger;
					// var coverage = sap.ui.getCore().byId("masterdata1::MasterData_master_IliabilityObjectPage--fe::FormContainer::GeneralInformation::FormElement::DataField::select_coverage::Field-edit").getValue();
					// var currency = sap.ui.getCore().byId("masterdata1::MasterData_master_IliabilityObjectPage--fe::FormContainer::GeneralInformation::FormElement::DataField::select_currencey::Field-edit").getValue();
