sap.ui.define(['sap/ui/core/mvc/ControllerExtension'], function (ControllerExtension) {
	...
	return ControllerExtension.extend('masterdata1.ext.controller.MasterObjectPAgeController', {
		// this section allows to extend lifecycle hooks or hooks provided by Fiori elements
		override: {
			/**
			 * Called when a controller is instantiated and its View controls (if available) are already created.
			 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
			 * @memberOf masterdata1.ext.controller.MasterObjectPAgeController
			 */
			onInit: function () {
			...
			routing: {
				...
				onAfterBinding: async function (oBindingContext) {
					...
					try {
						...
						var oUploadSet = sap.ui.getCore().byId("masterdata1::MasterDataObjectPage--fe::CustomSubSection::Attachaments--uploadSet");
						var oTemplate = oUploadSet.getBindingInfo("items").template
						...
						oUploadSet.bindAggregation("items", {
							path: oBindingContext.getPath() + "/master_newfiles",
