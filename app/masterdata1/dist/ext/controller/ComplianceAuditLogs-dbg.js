sap.ui.define([
    ...
    var oComplianceAuditDialog
    return {
        complianceAuditLogsPress: function(oEvent) {
            debugger
            oComplianceAuditDialog = new Dialog({
...
///////////////////////////////////////////////// m.Table ////////////////////////////
            ...
            oComplianceAuditDialog.addContent(oTable);
            this._view.addDependent(oComplianceAuditDialog);
        // }
        oComplianceAuditDialog.open();
        }
    };
});
